...
class ClientIntermediary {
    ...
    public ObjectInstance createMBean(String className,
        ...
        try {
            return (ObjectInstance) mBeanServerRequest(MBeanServerRequestMessage.CREATE_MBEAN,
                    new Object[]{
                        className,
                        name
                    },
    ...
    public ObjectInstance createMBean(String className,
        ...
        try {
            return (ObjectInstance) mBeanServerRequest(MBeanServerRequestMessage.CREATE_MBEAN_PARAMS,
                    new Object[]{
                        className,
                        name,
    ...
    public ObjectInstance createMBean(String className,
        ...
        try {
            return (ObjectInstance) mBeanServerRequest(MBeanServerRequestMessage.CREATE_MBEAN_LOADER,
                    new Object[]{
                        className,
                        name,
                        loaderName
    ...
    public ObjectInstance createMBean(String className,
        ...
        try {
            ...
            return (ObjectInstance) mBeanServerRequest(code,
                    new Object[]{
                        className,
                        name,
                        loaderName,
    ...
    public ObjectInstance getObjectInstance(ObjectName name, Subject delegationSubject) throws InstanceNotFoundException, IOException {
        ...
        try {
            return (ObjectInstance) mBeanServerRequest(MBeanServerRequestMessage.GET_OBJECT_INSTANCE,
                    new Object[]{name},
                    delegationSubject);
        } catch (InstanceNotFoundException e) {
            throw e;
    ...
    public Set queryMBeans(ObjectName name, QueryExp query, Subject delegationSubject) throws IOException {
        ...
        try {
            return (Set) mBeanServerRequest(MBeanServerRequestMessage.QUERY_MBEANS,
    ...
    public Set queryNames(ObjectName name, QueryExp query, Subject delegationSubject) throws IOException {
        ...
        try {
            return (Set) mBeanServerRequest(MBeanServerRequestMessage.QUERY_NAMES,
                    new Object[]{name, serialization.wrap(query)},
                    delegationSubject);
        } catch (Exception e) {
            throw appropriateException(e);
    ...
    public boolean isRegistered(ObjectName name, Subject delegationSubject) throws IOException {
        ...
        try {
            Boolean is = (Boolean) mBeanServerRequest(MBeanServerRequestMessage.IS_REGISTERED,
                    new Object[]{name},
                    delegationSubject);
    ...
    public Integer getMBeanCount(Subject delegationSubject) throws IOException {
        ...
        try {
            return (Integer) mBeanServerRequest(MBeanServerRequestMessage.GET_MBEAN_COUNT,
                    null,
                    delegationSubject);
        } catch (Exception e) {
            throw appropriateException(e);
    ...
    public Object getAttribute(ObjectName name,
        ...
        try {
            return mBeanServerRequest(MBeanServerRequestMessage.GET_ATTRIBUTE,
    ...
    public AttributeList getAttributes(ObjectName name,
        ...
        try {
            return (AttributeList) mBeanServerRequest(MBeanServerRequestMessage.GET_ATTRIBUTES,
    ...
    public AttributeList setAttributes(ObjectName name,
        ...
        try {
            ...
            return (AttributeList) mBeanServerRequest(MBeanServerRequestMessage.SET_ATTRIBUTES,
    ...
    public Object invoke(ObjectName name,
        ...
        try {
            return mBeanServerRequest(MBeanServerRequestMessage.INVOKE,
                    new Object[]{name,
                        operationName,
                        serialization.wrap(params),
                        signature},
    ...
    public boolean isInstanceOf(ObjectName name,
        ...
        try {
            Boolean is = (Boolean) mBeanServerRequest(MBeanServerRequestMessage.IS_INSTANCE_OF,
                    new Object[]{name,
                        className},
                    delegationSubject);
            return is;
    ...
    public void addNotificationListener(ObjectName name,
        ...
        try {
            int code = MBeanServerRequestMessage.ADD_NOTIFICATION_LISTENER_OBJECTNAME;
    ...
    private class GenericClientCommunicatorAdmin extends ClientCommunicatorAdmin {
        ...
        protected void doStop() {
            try {
                ...
                // we don't care about exceptions during close because it might be due to a network issue and will
                // fail anyway. Log only for debugging purpose. Close should never fail...
    ...
    private class GenericClientNotifForwarder extends ClientNotifForwarder {
        ...
        protected NotificationResult fetchNotifs(long clientSequenceNumber, int maxNotifications, long timeout) throws IOException, ClassNotFoundException {
            ...
            final NotificationResponseMessage nresp = (NotificationResponseMessage) connection.sendWithReturn(nreq);
        ...
        protected Integer addListenerForMBeanRemovedNotif() throws IOException, InstanceNotFoundException {
            ...
            final ObjectName[] names = {DELEGATE_NAME};
            ...
            try {
                ...
                Object o = mBeanServerRequest(code, params, null);
                if (o instanceof Integer) { // compatible with RI1.0: bug 4948444
                    return (Integer) o;
                } else {
                    return ((Integer[]) o)[0];
    ...
    private Object mBeanServerRequest(int methodId, Object[] params, Subject delegationSubject, boolean reconnect) throws Exception {
        ...
        try {
            ...
            // Normally, communicatorAdmin should have restored connection.
            // Try again to send request again
            resp = (MBeanServerResponseMessage) connection.sendWithReturn(req);
        }
