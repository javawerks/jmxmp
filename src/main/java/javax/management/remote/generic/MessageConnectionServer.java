 ...
 *
 * <p>
 * An instance of this interface can be communicated to the Generic Connector Server using the attribute {@link
 * GenericConnectorServer#MESSAGE_CONNECTION_SERVER} in the <code>Map</code> passed to its constructor.</p>
 */
