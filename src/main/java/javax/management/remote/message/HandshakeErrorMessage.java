 ...
 *
 * <p>
 * At any time during the handshake, if either the client or the server encounters a problem they can notify the other
 * peer by sending this indication message as to why the operation failed.
 * </p>
 *
...
public class HandshakeErrorMessage implements Message {
    ...
    public String toString() {
        return "HandshakeErrorMessage{" + "detail=" + detail + '}';
    }
}
