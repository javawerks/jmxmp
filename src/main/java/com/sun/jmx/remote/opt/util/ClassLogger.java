...
public class ClassLogger {
    ...
    private static final boolean LOGGING_EXISTS;
    ...
    static {
	   ...
	   people to use at least J2SE 1.4.  */
        ...
        LOGGING_EXISTS = loaded;
    }

    public ClassLogger(String subsystem, String className) {
        if (LOGGING_EXISTS) {
            logger = Logger.getLogger(subsystem + "." + className);
        } else {
            logger = null;
        }
    ...
    public final boolean warningOn() {
        return LOGGING_EXISTS && logger.isLoggable(java.util.logging.Level.WARNING);
    }

    public final boolean infoOn() {
        return LOGGING_EXISTS && logger.isLoggable(java.util.logging.Level.INFO);
    }

    public final boolean configOn() {
        return LOGGING_EXISTS && logger.isLoggable(java.util.logging.Level.CONFIG);
    }

    public final boolean fineOn() {
        return LOGGING_EXISTS && logger.isLoggable(java.util.logging.Level.FINE);
    }

    public final boolean finerOn() {
        return LOGGING_EXISTS && logger.isLoggable(java.util.logging.Level.FINER);
    }

    public final boolean finestOn() {
        return LOGGING_EXISTS && logger.isLoggable(java.util.logging.Level.FINEST);
    }
