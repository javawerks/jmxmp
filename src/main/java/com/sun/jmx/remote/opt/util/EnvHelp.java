...
public class EnvHelp {
    ...
    /**
     * Name of the attribute that specifies a default class loader object. The value associated with this attribute is a
     * ClassLoader object.
     */
    private static final String DEFAULT_CLASS_LOADER = JMXConnectorFactory.DEFAULT_CLASS_LOADER;

    /**
     * Name of the attribute that specifies a default class loader ObjectName. The value associated with this attribute
     * is an ObjectName object
     */
     ...
     * <var>env</var> for <tt>jmx.remote.default.class.loader.name</tt>, and registered in <var>mbs</var> if any.
     * </li>
     * <li>
     ...
     * </li>
     * <li>or
     * <tt>jmx.remote.default.class.loader</tt> is not an instance of {@link ClassLoader},
     * </li>
     * <li>or
     * <tt>jmx.remote.default.class.loader.name</tt> is not an instance of {@link ObjectName},
     * </li>
     * <li>or
     * <tt>jmx.remote.default.class.loader.name</tt> is specified but <var>mbs</var> is null.
     * </li>
     * @exception InstanceNotFoundException if
     * <tt>jmx.remote.default.class.loader.name</tt> is specified and the ClassLoader MBean is not found in
     * <var>mbs</var>.
     */
     ...
     * </pre> in its <tt>connect(Map env)</tt> method.
     *
     * @return The connector client default class loader.
     *
     * @exception IllegalArgumentException if
     * <tt>jmx.remote.default.class.loader</tt> is specified and is not an instance of {@link ClassLoader}.
     */
    ...
    /**
     * Init the cause field of a Throwable object. The cause field is set only if <var>t</var> has an
    ...
    /**
     * Returns the cause field of a Throwable object. The cause field can be got only if <var>t</var> has an
    ...
    /**
     * Name of the attribute that specifies the size of a notification buffer for a connector server. The default value
     * is 1000.
     */
     ...
     * server.. The value associated with this attribute should be an <code>Integer</code> object. The default value is
     * 1000.</p>
     */
    ...
    /**
     * <p>
     * Name of the attribute that specifies the timeout for a client to fetch notifications from its server. The value
     * associated with this attribute should be a <code>Long</code> object. The default value is 60000 milleseconds.</p>
     */
    ...
    /**
     * Get an integer-valued attribute with name <code>name</code> from <code>env</code>. If <code>env</code> is null,
     * or does not contain an entry for <code>name</code>, return <code>defaultValue</code>. The value may be a Number,
     * or it may be a String that is parsable as a long. It must be at least <code>minValue</code> and at
     * most<code>maxValue</code>.
     *
     * @throws IllegalArgumentException if <code>env</code> contains an entry for <code>name</code> but it does not meet
    ...
    /**
     * The value of this attribute, if present, is a string specifying what other attributes should not appear in
     * JMXConnectorServer.getAttributes(). It is a space-separated list of attribute patterns, where each pattern is
     * either an attribute name, or an attribute prefix followed by a "*" character. The "*" has no special significance
     * anywhere except at the end of a pattern. By default, this list is added to the list defined by
     * {@link #DEFAULT_HIDDEN_ATTRIBUTES} (which uses the same format). If the value of this attribute begins with an
     * "=", then the remainder of the string defines the complete list of attribute patterns.
     */
    ...
    private static final SortedSet DEFAULT_HIDDEN_STRINGS = new TreeSet();
    private static final SortedSet DEFAULT_HIDDEN_PREFIXES = new TreeSet();
    ...
    private static void hideAttributes(SortedMap map) {
        ...
        if (hide != null) {
            ...
            hide = DEFAULT_HIDDEN_ATTRIBUTES;
            synchronized (DEFAULT_HIDDEN_STRINGS) {
                if (DEFAULT_HIDDEN_STRINGS.isEmpty()) {
                    parseHiddenAttributes(hide, DEFAULT_HIDDEN_STRINGS, DEFAULT_HIDDEN_PREFIXES);
                }
                hiddenStrings = DEFAULT_HIDDEN_STRINGS;
                hiddenPrefixes = DEFAULT_HIDDEN_PREFIXES;
            }
        }
    ...
    /**
     * Name of the attribute that specifies the timeout to keep a server side connection after answering last client
     * request. The default value is 120000 milliseconds.
     */
    ...
    /**
     * Name of the attribute that specifies the period in millisecond for a client to check its connection. The default
