	 ...
	 * local address. */
        ...
        if (o != null && DefaultConfig.getServerReuseAddress(newEnv)) {
            try {
                ...
                // bind
                m2.invoke(ss, new Object[]{o, DEFAULT_BACKLOG});
...
// private variables
    ...
    private static final ClassLogger LOGGER = new ClassLogger("javax.management.remote.misc", "SocketConnectionServer");
}
