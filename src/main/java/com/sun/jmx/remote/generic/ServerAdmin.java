...
public interface ServerAdmin {
    ...
    /**
     * Tells that a new client is arrived and an implementation of this method is called to verify this client, for
     * example, to do authentication, to add a encription level to secure the connection etc.
     *
    ...
    /**
     * Returns an <code>javax.security.auth.Subject</code> object used for a server to authorize any request from the
