...
public interface ClientSynchroMessageConnection extends SynchroMessageConnection {
     ...
     * <P>
     * An implementation can throw <code>UnsupportedOperationException</code> to tell the caller that it is not
     * supported. For example, if the object is used on a server side and it is not mandatory for the server to send a
