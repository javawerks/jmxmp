 ...
 *
 * <p>
 * Each profile is created by an instance of {@link ProfileClientProvider}. This instance is found as follows. Suppose
 * the given <code><em>profile</em></code> looks like <code>TLS</code>. Then the factory will attempt to find the
 * appropriate {@link ProfileClientProvider} for <code><em>tls</em></code>. Suppose the given
 * <code><em>profile</em></code> looks like <code>SASL/PLAIN</code>. Then the factory will attempt to find the
 * appropriate {@link ProfileClientProvider} for <code><em>sasl</em></code>. The <code><em>profile</em></code> string
 ...
 * parameter, the class loader that loaded the <code>ProfileClientFactory</code> class is used.</p>
 *
 * <p>
 ...
 * ProfileClientProvider#createProfile(String,Map) createProfile} on the provider.</p>
 *
 * <p>
 * The <code>Map</code> parameter passed to the <code>ProfileClientProvider</code> is a new read-only copy of the
 * <code>environment</code> parameter to {@link
 * #createProfile(String, Map)
 * ProfileClientFactory.createProfile}, or an empty <code>Map</code> if that parameter is null. If the
 ...
 * <code>ProfileClientFactory</code> class.</p>
 */
public class ProfileClientFactory {
     ...
     * this attribute is an instance of {@link ClassLoader}.</p>
     */
     ...
     *
     * @return a <code>ProfileClient</code> representing the new profile. Each successful call to this method produces a
     * different object.
     *
