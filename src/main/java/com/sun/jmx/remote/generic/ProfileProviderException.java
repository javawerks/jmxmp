...
/**
 * Exception thrown by {@link ProfileClientFactory} and {@link ProfileServerFactory} when a provider exists for the
...
public class ProfileProviderException extends Exception {
     ...
     */
    public ProfileProviderException(String message, Exception cause) {
        super(message);
        this.cause = cause;
    }
