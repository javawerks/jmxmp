 ...
 * {@link ProfileClientFactory} as part of its {@link ProfileClientFactory#createProfile(String,Map) createProfile}
 * method.
 */
public interface ProfileClientProvider {

    /**
     * Create a new profile. Each successful call to this method produces a different <code>ProfileClient</code>
     * object.
     *
