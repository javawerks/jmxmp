...
public class SynchroMessageConnectionServerImpl implements SynchroMessageConnectionServer {
    ...
    public void start(Map env) throws IOException {
        ...
        messageConnectionServer.start(env);
    }

    @Override
    public ServerSynchroMessageConnection accept() throws IOException {
        LOGGER.trace("accept", "Waiting for an incoming client connection...");
        return new ServerSynchroMessageConnectionImpl(messageConnectionServer.accept(), env);
    }
    ...
    public JMXServiceURL getAddress() {
        return messageConnectionServer.getAddress();
    }

    /**
     * Returns the underlying asynchronous transport.
     *
     * @return the message connection server
     */
    public MessageConnectionServer getAsynchronConnection() {
        return messageConnectionServer;
    }
